...
A continuación se muestran las densidades de los valores que toman cada uno de los sensores en los datos observados. Se logra apreciar que existen sensores que tienen una densidad prácticamente idéntica como son los sensores 3 y 9.
...
Se procede a analizar la correlación entre las mediciones de los sensores para determinar cuáles están altamente correlacionados y retirar dichas variables dentro de los modelos de vida acelerada.
...
De la gráfica, anterior se decide dejar solamente una variable de aquellos pares que tengan una correlación arriba $0.90$. De esta forma las variables finales son:
...
Se procede a obtener el estimador Kaplan Meier para la función de supervivencia. A continuación se muestra la tabla conel resumen de los datos y la estimación no paramétrica de la función de supervivencia.
