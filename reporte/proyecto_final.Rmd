...
La log-verosimilitud de este modelo es: `r round(xfit_rlognorm1$loglik[2], 2)` por lo que se prefiere este modelo sobre el log-logistico y se comenzará la interpretación.
