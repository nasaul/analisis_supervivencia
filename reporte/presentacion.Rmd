...
tabla$table %>% 
  ...
  mutate(coef = c("Intercepto", "Configuración 1", "Configuración 2", "Configuración 3", "Log(scale)")) %>% 
...
```{r}
xfit_rloglog1 <- survreg(tiempo ~ datos_agg$conf_1 + datos_agg$conf_2 + datos_agg$conf_3, dist = "lognormal")
tabla <- summary(xfit_rloglog1)
